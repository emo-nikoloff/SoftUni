...
class Program
{
    static void Main(string[] args)
    {
        ...
        string connectionString =
            @"Server=localhost\SQLEXPRESS;Database=SoftUni;Trusted_Connection=True;Encrypt=False"; // специален string за свързване към база данни; има специален формат за всеки Data Provider/DB Server
