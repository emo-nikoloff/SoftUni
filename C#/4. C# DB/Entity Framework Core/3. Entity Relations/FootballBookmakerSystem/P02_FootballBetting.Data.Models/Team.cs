...
public class Team
{
    ...
    public virtual Color PrimaryKitColor { get; set; } = null!; /* използваме навигационно пропърти, защото 1 отбор има 1 главен екип/1 второстепенен екип; правим навигационното пропърти virtual,
                                                                   ...
                                                                   към базата данни, за да го изтегли 'в движение', преди да продължи изпълнението.". Така не се налага да се прави постоянно
                                                                   Eager Loading, чрез .Include(t => t.PrimaryKitColor) - данните се изтеглят автоматично точно в момента, в който бъдат поискани.
                                                                   Lazy Loading е изключен по подразбиране. За да бъде активиран трябва да се използва .UseLazyLoadingProxies() от пакета
