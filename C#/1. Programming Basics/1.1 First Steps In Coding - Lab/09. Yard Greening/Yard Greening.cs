...
// Напишете програма, която изчислява необходиматa сума, които Божидара ще трябва да заплати на фирмата изпълнител на проекта. Цената на един кв. м. е 7.61 лв със ДДС.
// Понеже нейният двор е доста голям, фирмата изпълнител предлага 18% отстъпка от крайната цена.
double area = double.Parse(Console.ReadLine());

double totalCosts = area * 7.61;
double discount = totalCosts * 0.18;
double finalCosts = totalCosts - discount;
Console.WriteLine($"The final price is: {finalCosts} lv.");
